...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    rows: [
      {
        keys: '새 버전',
        what: '앱을 켤 때 알아서 확인합니다. 받는 건 “받기” 를 눌러야 시작하고, 다 받으면 “지금 설치” 가 뜹니다 — 누르면 앱이 껐다 켜지면서 설치됩니다. 안 눌러도 트레이의 “완전히 종료” 로 끌 때 설치됩니다 (창의 X 는 트레이로 내려갈 뿐이라 설치되지 않습니다). 수집·송출 중에는 확인도 안 하고, 눌러도 한 번 물어봅니다'
      },
      {
        keys: '자동 실행',
        what: '“방송 › 방송 수집기” 의 「컴퓨터를 켤 때 자동으로 실행」 을 켜두면, 컴퓨터를 켤 때 창 없이 트레이에서 조용히 시작합니다. 앱이 꺼져 있으면 수집을 켤 수조차 없습니다'
      },
      {
        keys: '자동 수집',
        what: '바로 아래 「앱이 켜지면 수집도 자동으로 시작」 까지 켜면 누를 것이 없습니다 — 방송이 없으면 기다리다가 켜지면 붙습니다. 방송이 끝나고 20분이 지나면 세션을 닫아 다음 방송과 섞이지 않게 합니다'
      },
